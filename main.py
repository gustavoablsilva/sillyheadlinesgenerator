...
STATES = ['Portuguese', 'Nepalese', 'Netherlands', 'Lodz','Ulica Mazowiecka', 'New York', 'Katowice', 'Spanish', 'Karkonosze']
NOUNS = ['Jason Bourne', 'Clown', 'Wallet', 'Paleo Diet', 'Doctor', 'Parent',
          'Cat', 'Dog', 'Incel', 'Robot', 'Video Game', 'Prostitute without a leg', 'Chinese man','Serial Killer',
          'Telephone Psychic']
PLACES = ['House', 'Sex Shop', 'Bank Deposit Box', 'Mine', 'Tent', 'Stable', 'Donut Shop', 'Apocalypse Bunker']
WHEN = ['Yesterday', 'This Year', 'Later Today', 'RIGHT NOW', 'Next Week', 'As Soon As Possible']

def main():
     print('Silly Clickbait Headline Generator')
     print('By Gus, but inspired by the Big Big Book of Small Projects in Python.')

     print()

     print('Welcome to my first great AI program!')
     while True:
        print('This is how you generate fake news. Enter the number of clickbait headlines to generate:')
        response = input('> ')
     ...
     print('Post these to our', website, when, ', but remember: with great power comes great responsability.')
...
def generateReasonsWhyHeadline():
    ...
    return '{} Reasons Why {} Are More Interesting Than You Think (Number {} WillSurprise You!)'.format(number1, pluralNoun, number2)
